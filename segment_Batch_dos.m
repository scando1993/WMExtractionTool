...
%-----------------------------------------------------------------------
    ...
    matlabbatch{1}.spm.spatial.preproc.tissue(1).tpm = {[fullfile(matlabroot2,'tpm','TPM.nii'),',1']};
    ...
    matlabbatch{1}.spm.spatial.preproc.tissue(2).tpm = {[fullfile(matlabroot2,'tpm','TPM.nii'),',2']};
    ...
    matlabbatch{1}.spm.spatial.preproc.tissue(3).tpm = {[fullfile(matlabroot2,'tpm','TPM.nii'),',3']};
    ...
    matlabbatch{1}.spm.spatial.preproc.tissue(4).tpm = {[fullfile(matlabroot2,'tpm','TPM.nii'),',4']};
    ...
    matlabbatch{1}.spm.spatial.preproc.tissue(5).tpm = {[fullfile(matlabroot2,'tpm','TPM.nii'),',5']};
    ...
    matlabbatch{1}.spm.spatial.preproc.tissue(6).tpm = {[fullfile(matlabroot2,'tpm','TPM.nii'),',6']};
