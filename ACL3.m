function varargout = ACL3 (varargin)
...
uimenu(h0,'Label','Quit','Callback','ACL3(''Quit'');',... 
...
uicontrol(PM,'String','Help',...
     ...
     uicontrol(PM,'String','Quit',...
      ...
      uicontrol(PM,'String','Organizer',...
          'Position',[21 326 59 059].*WS,...
      'ToolTipString','Organizer folders of Study',...
      'CallBack','ACL3(''org_study'');',...
          'Tag','Org_study','FontSize',7);
      uicontrol(PM,'String','Clasificate',...
          'Position',[75 326 59 059].*WS,...
      'ToolTipString','clasificate folders of Study',...
      'CallBack','ACL3(''creategroups'');',...
...
%=======================================================================
    case 'fractalidadmni'
        prop_lesTESIS_dos (IP.root,'fractalidad','MNI')
%=======================================================================
%
%=======================================================================
    case 'fractalidadne'
        prop_lesTESIS_dos (IP.root,'fractalidad','NE')
%=======================================================================
%
%=======================================================================
    case 'cantidadmni'
        prop_lesTESIS_dos (IP.root,'cantidad','MNI')
%=======================================================================
%
%=======================================================================
    case 'cantidadne'
        prop_lesTESIS_dos (IP.root,'cantidad','NE')
%=======================================================================
%
%=======================================================================
    case 'volumenmni'
        prop_lesTESIS_dos (IP.root,'volumen','MNI')
%=======================================================================
%
%=======================================================================
    case 'volumenne'
